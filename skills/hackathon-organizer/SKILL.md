...
- `references/planning-and-logistics.md` — Timeline, venue, food, day-of operations, and post-event checklist
- `references/judging-and-prizes.md` — Judging formats, criteria design, judge recruitment, prize strategy
