-- Make captain_clerk_user_id nullable for pending captain invites
ALTER TABLE teams ALTER COLUMN captain_clerk_user_id DROP NOT NULL;

-- Track the pending captain's email on the team
ALTER TABLE teams ADD COLUMN IF NOT EXISTS pending_captain_email TEXT;

-- Flag captain invites in team_invitations
ALTER TABLE team_invitations ADD COLUMN IF NOT EXISTS is_captain_invite BOOLEAN NOT NULL DEFAULT FALSE;
...
BEGIN
  ...
  -- If this is a captain invite, assign the accepting user as team captain
