...
const DELAYS = [1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 0]
const JITTER_MS = 600
...
export default function EventImportLoading() {
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="max-w-md text-sm text-muted-foreground">
            The event page may be slow to respond, blocked, or missing structured event details.
