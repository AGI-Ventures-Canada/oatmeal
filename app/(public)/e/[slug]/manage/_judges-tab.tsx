...
import type { TrackProgress } from "@/lib/services/prize-tracks"
...
import { PrizeTracksManager } from "@/components/hackathon/prize-tracks/prize-tracks-manager"
  ...
  return (
    <div className="space-y-8">
      <PrizeTracksManager
        ...
        initialTracks={trackProgress.map((t) => ({
          id: t.trackId,
          name: t.trackName,
          description: null,
          intent: t.intent,
