...
name: hackathon-cli
model: sonnet
description: Use the Oatmeal CLI tool to manage hackathons from the terminal. Use when the user asks to create hackathons, add judges, manage prizes, or perform hackathon management tasks using the hackathon command-line tool.
activationKeywords:
  - "hackathon cli"
  - "hackathon command"
  - "create a hackathon"
...
- User mentions "hackathon" in the context of CLI hackathon management
